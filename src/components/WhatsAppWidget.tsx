...
const WhatsAppWidget: React.FC = () => {
    ...
    const handleSendMessage = () => {
        const phoneNumber = '919841421608';
        const text = message || 'Hello! I would like to inquire about your products.';
    ...
    return (
        <>
            ...
            {isOpen && (
                <div className="whatsapp-widget">
                    ...
                    <div className="widget-footer">
                        ...
                        <div className="powered-by">Powered by WhatsApp</div>
                    </div>
                </div>
            )}
            ...
            {/* Floating Button */}
            <button
                className={`whatsapp-float ${isOpen ? 'hidden' : ''}`}
