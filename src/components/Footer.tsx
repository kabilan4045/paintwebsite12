                ...
                <div className="footer__content">
                    ...
                    <div className="footer__brand">
                        ...
                        <p className="footer__description">
                            Trusted manufacturer of industrial, automotive, wood & decorative coatings since 1995. Delivering premium quality finishes for every surface.
                        </p>
                    ...
                    <div className="footer__column">
                        ...
                        <ul className="footer__contact">
                            <li className="footer__contact-item">
                                ...
                                <span>123 Industrial Estate, Ambattur, Chennai, Tamil Nadu 600068, India</span>
                            </li>
                            <li className="footer__contact-item">
                                <svg viewBox="0 0 24 24" fill="currentColor" className="footer__icon">
                            ...
                            <li className="footer__contact-item">
                                ...
                                <span>sales@yashwanthcoatings.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
